...
public class AutofitHelper {
	...
	public static AutofitHelper create(TextView view, AttributeSet attrs, int defStyle) {
		...
		if (attrs != null) {
			...
			sizeToFit = ta.getBoolean(R.styleable.HexagonButton_sizeToFit, true);
			minTextSize = ta.getDimensionPixelSize(R.styleable.HexagonButton_minTextSize, minTextSize);
			ta.recycle();
